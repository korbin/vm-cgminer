...
#./cgminer -d 1 --disable-gpu -S /dev/ttyUSB2 -S /dev/ttyUSB6 -S /dev/ttyUSB10 \
gdb -ex "break driver-icarus.c:1094" --args ./cgminer --real-quiet -d 4 --disable-gpu -S /dev/ttyUSB2 -S /dev/ttyUSB6 -S /dev/ttyUSB10 \
...
--icarus-timing 0.17 -o stratum+tcp://us.ironfish.herominers.com:1145 -u ${address} \
